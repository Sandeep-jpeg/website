...
const Industries = () => {
  return (
    <div>
      <section className='bg-[#252525] w-[1440px] h-[900px]'>
    ...
    <div className=" bg-[#777778] w-[471px] h-[450px] relative top-[200px] mx-auto px-2 rounded-[20px]">
    <div className=" p-[20px] ">
        <h2 className="Inter text-white text-2xl font-semibold leading-7 text-left p-[20px] mb-6">Fintech & Financial</h2>
        <ul className='space-y-3 mb-6 px-[20px]'>
          <li className='list-disc ml-4 Inter text-white w-[245px] h-[24px] text-[16px] font-medium leading-[24px] text-left'>Wallet and Banking Applications</li>
          <li className='list-disc ml-4 Inter text-white w-[245px] h-[24px] text-[16px] font-medium leading-[24px] text-left'>Wallet and Banking Applications</li>
          <li className='list-disc ml-4 Inter text-white w-[245px] h-[24px] text-[16px] font-medium leading-[24px] text-left'>Wallet and Banking Applications</li>
          <li className='list-disc ml-4 Inter text-white w-[245px] h-[24px] text-[16px] font-medium leading-[24px] text-left'>Wallet and Banking Applications</li>
        </ul>
